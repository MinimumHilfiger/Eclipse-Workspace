public class Person {
	...
	public static void main(String[] args) throws Exception {
		...
		Person person1 = new Person(iIO.promptAndRead("Name:"),iIO.promptAndRead("Vorname:"),iIO.promptAndRead("Beruf:"),iIO.promptAndRead("Lieblingsfarbe:"),iIO.promptAndRead("Lieblingstier:"));
		iIO.write(person1.toString());
		
		iIO.write("Bitte geben Sie die Informationen der zweiten Personen ein.");
		Person person2 = new Person(iIO.promptAndRead("Name:"),iIO.promptAndRead("Vorname:"),iIO.promptAndRead("Beruf:"),iIO.promptAndRead("Lieblingsfarbe:"),iIO.promptAndRead("Lieblingstier:"));
	...
	public String toString() {
		String Ausgabe = "Name: "+name+ ", "+"Vorname: "+vorname+ ", "+"Beruf: "+beruf+ ", "+"Lieblingsfarbe: "+lieblingsFarbe+ ", "+"Lieblingstier: "+lieblingsTier;
		return Ausgabe;
	}
